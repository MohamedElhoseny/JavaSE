...
public class HamburgerDemo extends Application {
	...
	@Override public void start(Stage stage) {
		...
		HamburgerBasicCloseTransition burgerTask1 = new HamburgerBasicCloseTransition(h2);  //n7dd el no3 w nb3tlo el object
		burgerTask1.setRate(-1);  //n7dd el rate  daymn be -1
